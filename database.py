...
class Database:
    ...
    def setup_default_schedule(self):
        ...
        try:
            ...
            logger.error(f"Ошибка при установке графика по умолчанию: {e}")
            self.conn.rollback()
    ...
    def get_appointments_by_datetime(self, date, time):
        ...
        try:
            ...
            logger.error(f"Ошибка при получении записей по дате и времени: {e}")
            return []
    ...
    def set_work_schedule(self, weekday, start_time, end_time, is_working=True):
        ...
        try:
            ...
            logger.error(f"Ошибка при установке графика работы: {e}")
            self.conn.rollback()
    ...
    def get_work_schedule(self, weekday=None):
        ...
        try:
            ...
            logger.error(f"Ошибка при получении графика работы: {e}")
            return []
    ...
    def get_appointments_for_24h_reminder(self):
        ...
        try:
            ...
            logger.error(f"Ошибка при получении записей для напоминания за 24 часа: {e}")
            return []
    ...
    def get_appointments_for_1h_reminder(self):
        ...
        try:
            ...
            logger.error(f"Ошибка при получении записей для напоминания за 1 час: {e}")
            return []
    ...
    def mark_24h_reminder_sent(self, appointment_id):
        ...
        try:
            ...
            logger.error(f"Ошибка при отметке напоминания за 24 часа: {e}")
            self.conn.rollback()
    ...
    def mark_1h_reminder_sent(self, appointment_id):
        ...
        try:
            ...
            logger.error(f"Ошибка при отметке напоминания за 1 час: {e}")
            self.conn.rollback()
    ...
    def set_notification_chat(self, admin_id, chat_id):
        ...
        try:
            ...
            logger.error(f"Ошибка при установке чата для уведомлений: {e}")
            self.conn.rollback()
    ...
    def get_notification_chats(self):
        ...
        try:
            ...
            logger.error(f"Ошибка при получении чатов для уведомлений: {e}")
            return []
    ...
    def get_total_users_count(self):
        ...
        try:
            ...
            logger.error(f"Ошибка при получении общего количества пользователей: {e}")
            return 0
    ...
    def cleanup_completed_appointments(self):
        ...
        try:
            ...
            logger.error(f"Ошибка при очистке завершенных записей: {e}")
            self.conn.rollback()
            return {
                'deleted_past_dates': 0,
                'deleted_today': 0,
                'total_deleted': 0
            }
